...
// Planer custom: Chat + IA sidebar items
export const PLANER_SIDEBAR_ITEMS: Record<string, IWorkspaceSidebarNavigationItem> = {
  chat: {
    key: "chat",
